    ...
    return (
        <div className="bg-white p-4 rounded-lg shadow-md w-full max-w-screen-xl mx-auto">
            ...
            <div className="relative bg-gray-100 p-2 rounded-xl overflow-hidden">
                ...
                {/* Trending Tabs */}
                <div
                    className="flex items-center space-x-6 w-full px-24 overflow-hidden"
                ...
                >
                    {tabItems.map((item, index) => (
                        <button
                            key={index}
                            className="bg-gray-200 px-11 py-2 rounded-full hover:bg-red-600 transition duration-300 hover:scale-105 text-nowrap flex-nowrap"
                        >
                            {item}
                        </button>
                    ))}
